...
\begin{titlepage} 
	...
	\textsc{\Large Vloeistofdynamica}\\[0.5cm] % Hoofdonderwerp 
	...
	{\huge\bfseries Leeglopen van een emmer}\\[0.4cm] % Hoofdtitel
	...
	\vfill\vfill
	\includegraphics[width=0.4\textwidth]{torricelli.pdf}\\[1cm] % Ons fysica logootje
